...
export default {
  setup() {
    ...
    console.log('cart.value-->', JSON.stringify(cart.value))
    ...
    const updateMyCart = async (actions) => {
      console.log('actions', JSON.stringify(actions))
      const activeCart = undefined;
      try {
        ...
        if (!cart.value && !activeCart && store.state.activeCart?.data?.updateMyCart) {
          console.log('under 2')
          me.value.activeCart = store.state.activeCart?.data?.updateMyCart;
        ...
        console.log('store.state.activeCart---->', JSON.stringify(store.state.activeCart, null, 2))
